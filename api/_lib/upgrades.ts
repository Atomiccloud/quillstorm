...
export const UPGRADE_LOOKUP: Record<string, UpgradeEntry> = {
  ...
  elite_hunter: { effects: { eliteDamageBonus: 0.25 } },
  ...
  crit_2: { effects: { critChance: 0.15, critDamage: 0.5 } },
  ...
  crit_master: { effects: { critChance: 0.25, critDamage: 1.0 } },
  ...
  sniper: { effects: { damage: 1.0, piercing: 5, fireRate: -0.3, projectileSpeed: 0.8 }, maxStacks: 1 },
  ...
  glass_god: { effects: { damage: 1.5, critChance: 0.3, critDamage: 1.0, maxHealth: -50 }, maxStacks: 1 },
  nuclear_quills: { effects: { explosionRadius: 150, damage: 0.8, fireRate: -0.3 }, maxStacks: 1 },
